...
let updateTime: string = '/blog-api/blog/updatetime';

let notNeedTokenUrlList: string[] = [login, register, categoryList, blogList, blogDetail, likeBlog, addComments, updateTime];
